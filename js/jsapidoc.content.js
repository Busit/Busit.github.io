	...
	'bi':
	{
		'bi':
		{
			...
			sample: ['&lt;head&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;script type="text/javascript" src="/js/bi.js"&gt;&lt;/script&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;script type="text/javascript&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bi.onLoad(function() { console.log("Ready!"); });<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;/script&gt;<br />&lt;/head&gt;',
				'"use strict";<br />// Sample module<br /><br />bi.require(["my_dependency1"], function()<br />{<br />&nbsp;&nbsp;&nbsp;&nbsp;// this code portion is guaranteed to be executed only when the dependent modules are loaded<br />&nbsp;&nbsp;&nbsp;&nbsp;window.my_module = { foo: "bar" };<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;// notify the framework that the module is ready<br />&nbsp;&nbsp;&nbsp;&nbsp;bi.fire(bi, "provide", ["my_module"]);<br />});'],
			properties:
			{
