jsapidoc.content['Single Page Application'] = 
{
	'1) Concepts':
	{
		...
		description: 'A Single Page Application aims at providing an entire multi-page website without actually browsing to a different URL. This provides a seamless browsing experience to the user.<br /><br />' + 
			...
			'The concept of Single Page Application also implies that all requests to the backend application server are performed using ajax requests such that the application remains responsive during background operations.<br />' +
			'The Busit WebApps are designed using this technique to interact with the REST API.'
	},
	'2) Entry point':
	{
